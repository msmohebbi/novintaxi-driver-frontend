...
import 'package:novintaxidriver/screens/waiting_screen.dart';
...
import 'package:novintaxidriver/widgets/page_3.dart';
import 'package:novintaxidriver/widgets/page_4.dart';
...
class _DriverProfileScreenState extends State<DriverProfileScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    if (Provider.of<DriverData>(context).isDataComplete && !Provider.of<DriverData>(context).isEditRequested) {
      currentIndex = 5;
    }
